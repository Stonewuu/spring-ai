 ...
 */
package org.springframework.ai.googleai.gemini.function;
...
import org.springframework.ai.googleai.gemini.GoogleAiGeminiChatOptions;
...
public class GoogleAiGeminiChatModelFunctionCallingIT {
	...
	public void functionCallExplicitOpenApiSchema() {
		...
		var promptOptions = GoogleAiGeminiChatOptions.builder()
			.withModel(GeminiAiApi.ChatModel.GEMINI_PRO)
	...
	public void functionCallTestInferredOpenApiSchema() {
		...
		var promptOptions = GoogleAiGeminiChatOptions.builder()
			// .withModel(VertexAiGeminiModelCall.ChatModel.GEMINI_PRO_1_5_PRO)
			.withModel(GeminiAiApi.ChatModel.GEMINI_PRO.getValue())
	...
	public static class TestConfiguration {
		...
		@Bean
		public GeminiAiApi geminiAiApi() {
			return new GeminiAiApi(null,"AIzaSyD-HWzB82smPt_13PPTsywwgyihHGpDskI");
		}

		@Bean
		public GoogleAiGeminiChatModel googleAiGeminiChatModel(GeminiAiApi geminiAiApi) {
			return new GoogleAiGeminiChatModel(geminiAiApi,
