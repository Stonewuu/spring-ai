...
class GoogleAiGeminiChatModelIT {
	...
	void textStream() {
		...
		System.out.println(generationTextFromStream);
	...
	public static class TestConfiguration {
		...
		public GeminiAiApi geminiAiApi() {
			return new GeminiAiApi("AIzaSyD-HWzB82smPt_13PPTsywwgyihHGpDskI");
		}
		...
		public GoogleAiGeminiChatModel googleAiGeminiChatModel(GeminiAiApi geminiAiApi) {
			return new GoogleAiGeminiChatModel(geminiAiApi,
					GoogleAiGeminiChatOptions.builder().withModel(GeminiAiApi.ChatModel.GEMINI_PRO).build());
		}
